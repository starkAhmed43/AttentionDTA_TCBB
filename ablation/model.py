...
class DTANN(pl.LightningModule):
    ...
    def __init__(self, input_dim, num_hid_layers, learning_rate=1e-3):
        ...
        self.train_mse = tm.MeanSquaredError(squared=False)
        self.val_mse = tm.MeanSquaredError(squared=False)
        self.test_mse = tm.MeanSquaredError(squared=False)
    ...
    def test_step(self, batch, batch_idx):
        ...
        self.log("test_mse", self.test_mse, on_step=False, on_epoch=True, prog_bar=True)
