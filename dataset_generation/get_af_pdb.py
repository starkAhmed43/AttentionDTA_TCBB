...
DATA_PATH = SCRIPT_DIR.parent / "data/alphafold"
...
LOG_PATH = SCRIPT_DIR.parent / "logs/alphafold"
...
if __name__ == "__main__":
    ...
    logger.info(f"Saving IDs of proteins without PDB structures in AFDB to {DATA_PATH / 'no_af_pdbs_sequences.pkl'}...")
    with open(DATA_PATH / "no_af_pdbs.pkl", "wb") as f:
        pickle.dump(no_af_pdbs, f)
    logger.info(f"Saved {len(no_af_pdbs)} IDs of proteins without PDB structures in AFDB to {DATA_PATH / 'no_af_pdbs.pkl'}.")